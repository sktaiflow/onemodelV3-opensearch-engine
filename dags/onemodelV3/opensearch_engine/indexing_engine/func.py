...
@exception_handle_operation(InternalCodes.DELETE_DOCUMENT_ERROR)
...
@exception_handle_operation(InternalCodes.UPDATE_DOCUMENT_ERROR)
...
@exception_handle_operation(InternalCodes.CREATE_CLIENT_ERROR)
...
@exception_handle_operation(InternalCodes.INDEXING_ERROR)
